        ...
        <div class="col-md-6 offset-md-3 form-con">
            ...
            <form action="${pageContext.request.contextPath}/handle-product" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control my-input" id="name" name="name" value="${product.name}" placeholder="Product Name">
                </div>

                <div class="form-group">
                    <label for="price">Price</label>
                    <input type="text" class="form-control my-input" id="price" value="${product.price}" name="price" placeholder="Price">
                </div>

                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control my-input" id="description"  name="description" rows="4" placeholder="Share standout features, benefits, and qualities">${product.description}</textarea>
                </div>

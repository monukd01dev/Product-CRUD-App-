            ...
            <div class="col-md-6 offset-md-3 form-con">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-input" id="description" name="description" rows="4" placeholder="Share standout features, benefits, and qualities that set your product apart"></textarea>
                    </div>
                    ...
                    <div class="container " style="margin-top: 30px">
                        <div class="row ">
                            ...
                            <div class="col-md-5">
                                <a href="" style="text-decoration: none"><button type="button" class="btn btn-danger btn-lg btn-block">Back</button></a>
                            </div>
                            <div class="col-md-5 ">
